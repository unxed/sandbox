...
## Что проверено (на pinned unxed/go 84e3d83d, ядро с патчем)

- `f4 --version`, `--help`, `--list-mounts`: ок.
- `f4 --tty` в pty: 6 запусков из 6 сразу рисуют панели и отвечают на F1 ([run 35408645733](https://github.com/unxed/sandbox/actions/runs/35408645733));
  на c6fbbabd было 5 из 6, на 9adc5fe (fork для pty-шелла) — большинство запусков зависало.
- Просмотрщик (F3, `screens/viewer-f3.png`), редактор (F4: ввод текста, признак изменения `*`,
  диалог «сохранить?» по Esc, `screens/editor-*.png`) — работают.
