# relibc: posix_spawn leaves close-on-exec descriptors open in the child (for GitLab MR)

Upstream: https://gitlab.redox-os.org/redox-os/relibc (patch made against master 69bb008af1).

    git am 0001-redox-posix_spawn-close-the-parent-s-close-on-exec-d.patch
